...
enum phase1_role tc14_init      = RESPONDER;

/* secret value */
unsigned char tc14_secretr[] = {
...
unsigned int tc14_secretr_len = sizeof(tc14_secretr);
...
unsigned int tc14_gr_len = sizeof(tc14_gr);
...
unsigned char tc14_nr[] = {
 0xc6, 0xba, 0x31, 0x9f,  0x88, 0x5b, 0xe7, 0xb7,
 0xa2, 0x93, 0x85, 0xdc,  0xbb, 0xc6, 0x15, 0x84
};
unsigned int tc14_nr_len = sizeof(tc14_nr);

unsigned char tc14_results_shared[]= {
...
unsigned char tc14_results_skeyseed[]= {
...
unsigned char tc14_results_skey_ar[]= {
